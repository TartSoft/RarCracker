@Echo off
@Title WinRar Pass cracker 1.3 ^| An update for Rar Zip Pass Cracker by Psi505
@mode 78,15
...
echo      /_/    \_,_/ /___//___/    \___/  /_/   \_,_/ \__/ /_/\_\ \__/ /_/   v1.3
echo.
echo.
echo.
echo        Author  : Psi505 + duongletrieu   ^|  Description : This is a simple batch program
echo        Version : 1.3      ^|  to help you crack Rar/Zip/7z passwords.
echo.
echo   :=-----------------------------------------------------------------------=:
timeout /t 8 >nul
::-----------------------------------::
